                    ...
                    <div id="kt_toolbar_container" class="container-xxl py-5">
                        ...
                        <div class="row gy-0 gx-10">
                            <div class="col-xl-12 bg-w pd-30">
                                <h2 class="mb-4">Completed Audits</h2>
                                <div class="row mb-10">
                                    <div class="col-md-12">
                                ...
                                <div v-else-if="store.auditList.length">
                                    <CompletedAuditListSup :auditList="store.auditList" v-if="account[0].Account_type == 1" />
                                    <CompletedAuditList :auditList="store.auditList" v-else />
...
import CompletedAuditListSup from '@/components/audit/supplier/CompletedAuditListSup.vue';
import CompletedAuditList from '@/components/audit/audit-firm/CompletedAuditList.vue'
