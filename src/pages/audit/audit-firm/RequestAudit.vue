                    ...
                    <div id="kt_toolbar_container" class="container-xxl py-5">
                        <div class="row gy-0 gx-10">
                            <div class="col-xl-12 bg-w pd-30">
                                <h2 class="mb-4">Audits Requests</h2>
                                <div class="row mb-10">
                                    <div class="col-md-12">
                                        <ul
                                ...
                                <div v-else-if="store.auditList.length">
                                        <AuditRequestList :auditList="store.auditList" />
...
import AuditRequestList from '@/components/audit/audit-firm/AuditRequestList.vue'
