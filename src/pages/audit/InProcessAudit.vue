                ...
                <div id="kt_toolbar_container" class="container-xxl py-5">
                    ...
                    <div class="row gy-0 gx-10">
                        <div class="col-xl-12 bg-w pd-30">
                            <h2 class="mb-4">In Process Audits</h2>
                            <div class="row mb-10">
                                <div class="col-md-12">
                            ...
                            <div v-else-if="store.auditList.length">
                                <InProcessAuditListSup :auditList="store.auditList" v-if="account[0].Account_type == 1" />
                                <InProcessAuditList :auditList="store.auditList" v-else />
...
import InProcessAuditListSup from "@/components/audit/supplier/InProcessAuditListSup.vue";
import InProcessAuditList from "@/components/audit/audit-firm/InProcessAuditList.vue"
