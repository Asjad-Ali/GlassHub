						...
						<div id="kt_toolbar_container" class="container-xxl py-5">
							<div class="row gy-0 gx-10">
                                <div class="col-xl-9 pd-30 bg-w">
                                    <div class="row ">
                                        <div class="col-md-8">
                                            <h1 class="pb-2">Suppliers Registration</h1>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <li class="nav-item">
                                              <router-link to="suppliers_register"><a class="nav-link "><h5>Registered</h5></a></router-link>
                                            </li>
                                            <li class="nav-item">
                                                  <router-link to="supplier_new_requests"><a class="nav-link active"><h5>New Requests</h5></a></router-link>
                                            </li>
                                            <li class="nav-item">
                                              <router-link to="supplier-request-registration"><a class="nav-link " ><h5>Request Registration</h5></a></router-link>
                                            </li>
                                        </ul>
                                        </div>
                                    </div>
...
onMounted(() => {
    ...
    store.loadRegistrationHelpText(`${account.value[0].Account_type}/Suppliers/New Request/null`)
} )
</script>