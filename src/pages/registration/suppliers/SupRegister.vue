                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="topmenutabs nav nav-tabs nav-line-tabs mb-5 fs-6">
                                ...
                                <li class="nav-item">
                                    <router-link to="suppliers_register"><a class="nav-link active"><h5>Registered</h5></a></router-link>
                                </li>
                                <li class="nav-item">
                                        <router-link to="supplier_new_requests"><a class="nav-link "><h5>New Requests</h5></a></router-link>
                                </li>
                                <li class="nav-item">
...
onMounted(() => {
  ...
  store.loadRegistrationHelpText(`${account.value[0].Account_type}/Suppliers/Registered/null`)
} )
</script>
