                            ...
                            <div class="col-xl-9 pd-30 bg-w">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <li class="nav-item">
                                            <router-link to="regulator_register"><a class="nav-link "><h5>Registered</h5></a></router-link>
                                        </li>
                                        <li class="nav-item">
                                                <router-link to="regulator_new_request"><a class="nav-link "><h5>New Requests</h5></a></router-link>
                                        </li>
                                        <li class="nav-item">
                                            <router-link to="regulator_request_registration"><a class="nav-link active" ><h5>Request Registration</h5></a></router-link>
                                        </li>
                                    </ul>
                                    </div>
                                </div>
...
onMounted(() => {
     store.loadRegistrationHelpText(`${account.value[0].Account_type}/Regulator/Request Registeration/null`)
} )
