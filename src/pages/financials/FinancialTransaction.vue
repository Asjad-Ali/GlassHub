                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-10">
                    <div class="mb-0">
                      ...
                      <Datepicker v-model="date" range multiCalendars :format="format"></Datepicker>
                    </div>
                  </div>
                </div>
                    ...
                    >
                      ...
                      <li class="nav-item">
                        <router-link to="summary"
                          ><a class="nav-link"><h5>Summary</h5></a></router-link
                        >
                      </li>
                    </ul>
                  </div>
...
import FinancialTransaction from "@/components/financials/FinancialTransaction.vue";
...
watch(date,()=>{
 ...
 store.getFinancial({start_time:start_time.value.toISOString().substring(0, 10),end_time:end_time.value.toISOString().substring(0, 10)})
})


onMounted(()=>{
  store.getFinancial({start_time:'null',end_time:'null'})
})
</script>
