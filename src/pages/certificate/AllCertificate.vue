                                    ...
                                    <div class="row ">
                                        <div class="col-md-12">
                                            <ul class="topmenutabs nav nav-tabs nav-line-tabs mb-5 fs-6">
                                                <li  class="nav-item ">
                                                  <router-link to="/certificate" class="nav-link cursor-pointer active" ><h5>All Certificates</h5></router-link>
                                                </li>
                                                <li  class="nav-item">
                                                  <router-link to="/expired-certificate"  class="nav-link cursor-pointer "  ><h5>Expired Certificates</h5></router-link>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
...
export default {
    ...
    //   const router = useRouter()
     ...
     watch(SwitchAccount,()=>{
         GetRecord()
         regStore.loadRegistrationHelpText(`${SwitchAccount.value.Account_type}/All Certificates/null/null`)
     })
      const cal_row =(value)=>{
      ...
      const GetRecord= async() => {
        loader.value = true
       await Api.get(`/api/Certificate/GetList/${SwitchAccount.value.Account_type}/${SwitchAccount.value.RegD_id}/null/${current_page.value}/10/0`)
       .then(response=>{
