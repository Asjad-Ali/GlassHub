...
import AddCompliance from "@/components/compliance/AddCompliance.vue";
import {onMounted} from 'vue'
import {Account} from '@/store/SwitchAccount'
const Account_info = Account()
const regStore = useRegisterationStore() 
onMounted(()=>{
  regStore.loadRegistrationHelpText(`${Account_info.Account_detail[0].Account_type}/Compliance/Add Compliance/null`)
})
</script>
