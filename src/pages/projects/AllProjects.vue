            ...
            <div class="row gy-0 gx-10">
              <div class="col-xl-9 bg-w pd-30 pendingprojects_all_lists">
                  ...
                  <div class="row">
                      <div class="col-md-12">
                            <ul class="topmenutabs nav nav-tabs nav-line-tabs mb-5 fs-6">
                              ...
                              <li class="nav-item">
                                  <router-link to="/all_projects"><a class="nav-link active"><h5>All</h5></a></router-link> 
                              </li>                             
                              <li class="nav-item">
                ...
                <div class="row">
                  ...
                  <div v-else>
                    <div v-if="store.bidProjectList.length">
                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    ...
                                    <tbody>
                                        <tr v-for="(project) in store.bidProjectList" :key="project">
                                            ...
                                            <td>
                                                <span v-if="project.Bid_status == 1 " class="badge badge-secondary">  Pending </span>
                                                <span v-if="project.Bid_status == 2 " class="badge badge-primary">  In Process </span>
                                                <span v-if="project.Bid_status == 3 " class="badge badge-success">  Completed </span>
                                                <span v-if="project.Bid_status ==  4" class="badge badge-danger">  Cancelled </span>
                                            </td>
                                            <!-- <td>
                                                <span v-if="project.Isdirect" class="badge badge-success"> Direct </span>
                                                <span v-else class="badge badge-primary"> Indirect </span>
                                            </td> -->
...
// import AllProjects from '@/components/projects/Listing/AllProjects.vue'
