          ...
          module.exports = function (window, document, jquery, navigator) {
            ...
            OAuthio = {
              ...
              setOAuthdURL: function (url) {
                ...
                config.oauthd_base = Url.getAbsUrl(config.oauthd_url).match(
                  /^.{2,5}:\/\/[^\/]+/
                )[0];
              },
          ...
          module.exports = function (OAuthio) {
            ...
            (parse_urlfragment = function () {
              ...
              if (results) {
                ...
                oauth_result = decodeURIComponent(
                  results[1].replace(/\+/g, " ")
                );
            ...
            oauth = {
              ...
              create: function (provider, tokens, request) {
                ...
                make_res_endpoint = function (method, url) {
                  return oauthio.request.mkHttpEndpoint(
                    provider,
                    tokens,
                    request,
                    method,
                ...
                res.me = oauthio.request.mkHttpMe(
                  provider,
                  tokens,
                  request,
                  "GET"
              ...
              popup: function (provider, opts, callback) {
                ...
                if (!config.key) {
                  ...
                  if (callback == null) {
                    ...
                    return callback(
                      new Error("OAuth object must be initialized")
                    );
                  }
                }
                ...
                url =
                  config.oauthd_url + "/auth/" + provider + "?k=" + config.key;
                ...
                wnd_settings.left = Math.floor(
                  window.screenX + (window.outerWidth - wnd_settings.width) / 2
                );
                wnd_settings.top = Math.floor(
                  window.screenY +
                ...
                wnd_options +=
                  ",left=" + wnd_settings.left + ",top=" + wnd_settings.top;
                opts = {
                  provider: provider,
                  cache: opts.cache,
                };
                ...
                if (
                  ...
                  frm.src =
                    config.oauthd_url +
                    "/auth/iframe?d=" +
                    encodeURIComponent(Url.getAbsUrl("/"));
                  frm.width = 0;
                  frm.height = 0;
                  frm.frameBorder = 0;
                      ...
                      if (!gotmessage) {
                        ...
                        if (
                          ...
                          return opts.callback(
                            new Error("The popup was closed")
                          );
                        }
                      }
                    }
              ...
              isRedirect: function (provider) {
                ...
                if (
                  (oauth_result != null
                    ? oauth_result.substr(0, 6)
                    : void 0) === "cache:"
                ) {
                  cache_provider =
                    oauth_result != null ? oauth_result.substr(6) : void 0;
                  if (!provider) {
                    return cache_provider;
                  }
                  return (
                    cache_provider.toLowerCase() === provider.toLowerCase()
                  );
                }
                try {
              ...
              callback: function (provider, opts, callback) {
                ...
                if (
                  cache.cacheEnabled(opts != null ? opts.cache : void 0) ||
                  (oauth_result != null
                    ? oauth_result.substr(0, 6)
                    : void 0) === "cache:"
                ) {
                ...
                $.ajax({
                  ...
                  .always(function () {
                    if (typeof providers_desc[provider] !== "object") {
                      ...
                      providers_api.execProvidersCb(
                        provider,
                        new Error("Unable to fetch request description")
                      );
                    }
                  });
              },
            ...
            return {
              ...
              generateMethods: function (request_object, tokens, provider) {
                ...
                if (extended_methods != null) {
                  results = [];
                  for (
                    k = j = 0, len = extended_methods.length;
                    j < len;
                    k = ++j
                  ) {
              ...
              http: function (opts) {
                ...
                doRequest = function () {
                  ...
                  if (!request.cors) {
                    ...
                    options.url =
                      config.oauthd_url +
                      "/request/" +
                      options.oauthio.provider +
                      options.url;
                    options.headers = options.headers || {};
                    options.headers.oauthio = "k=" + config.key;
                    if (
                      options.oauthio.tokens.oauth_token &&
                      options.oauthio.tokens.oauth_token_secret
                    ) {
                      options.headers.oauthio += "&oauthv=1";
                    }
                    for (k in options.oauthio.tokens) {
                      options.headers.oauthio +=
                        "&" +
                        encodeURIComponent(k) +
                        "=" +
                        encodeURIComponent(options.oauthio.tokens[k]);
                    }
                  ...
                  if (options.oauthio.tokens) {
                    if (options.oauthio.tokens.access_token) {
                      options.oauthio.tokens.token =
                        options.oauthio.tokens.access_token;
                    }
                    ...
                    if (request.headers) {
                      ...
                      for (i in request.headers) {
                        options.headers[i] = Url.replaceParam(
                          request.headers[i],
                          options.oauthio.tokens,
                          request.parameters
                        );
                ...
                if (
                  !options.oauthio.request ||
                  options.oauthio.request === true
                ) {
                  desc_opts = {
                    wait: !!options.oauthio.request,
                  };
                  defer = $.Deferred();
                  providers_api.getDescription(
                    options.oauthio.provider,
                    desc_opts,
                    function (e, desc) {
                      if (e) {
                      ...
                      if (
                        ...
                        options.oauthio.request =
                          desc.oauth1 && desc.oauth1.request;
                      } else {
                        options.oauthio.request =
                          desc.oauth2 && desc.oauth2.request;
                      }
                      defer.resolve();
                    }
                  );
              ...
              mkHttpAll: function (provider, tokens, endpoint_descriptor) {
                ...
                return function () {
                  ...
                  options.url =
                    config.oauthd_url +
                    endpoint_descriptor.endpoint.replace(":provider", provider);
                  options.oauthio = {
                    provider: provider,
                    tokens: tokens,
                  };
              ...
              sendCallback: function (opts, defer) {
                ...
                if (
                  opts.provider &&
                  data.provider.toLowerCase() !== opts.provider.toLowerCase()
                ) {
                  err = new Error(
                    "Returned provider name does not match asked provider"
                  );
                  defer.reject(err);
                  if (opts.callback && typeof opts.callback === "function") {
          ...
          module.exports = function (OAuthio) {
            ...
            UserObject = (function () {
              ...
              UserObject.prototype.save = function () {
                ...
                this.saveLocal();
                return OAuthio.API.put(
                  "/api/usermanagement/user?k=" +
                    config.key +
                    "&token=" +
                    this.token,
                  dataToSave
              ...
              UserObject.prototype.hasProvider = function (provider) {
                return (
                  !!this.providers && this.providers.indexOf(provider) !== -1
                );
              };
              ...
              UserObject.prototype.getProviders = function () {
                ...
                defer = $.Deferred();
                OAuthio.API.get(
                  "/api/usermanagement/user/providers?k=" +
                    config.key +
                    "&token=" +
                    this.token
                )
              ...
              UserObject.prototype.addProvider = function (oauthRes) {
                ...
                OAuthio.API.post(
                  ...
                  .fail(
                    (function (_this) {
                      return function (err) {
                        _this.providers.splice(
                          _this.providers.indexOf(oauthRes.provider),
                          1
                        );
                        return defer.reject(err);
                      };
              ...
              UserObject.prototype.removeProvider = function (provider) {
                ...
                OAuthio.API.del(
                  "/api/usermanagement/user/providers/" +
                    provider +
                    "?k=" +
                    config.key +
                    "&token=" +
              ...
              UserObject.prototype.changePassword = function (
                oldPassword,
                newPassword
              ) {
                return OAuthio.API.post(
                  "/api/usermanagement/user/password?k=" +
                    config.key +
                    "&token=" +
                    this.token,
                  {
              ...
              UserObject.prototype.logout = function () {
                ...
                storage.erase("oio_auth");
                OAuthio.API.post(
                  "/api/usermanagement/user/logout?k=" +
                    config.key +
                    "&token=" +
                    this.token
                )
            ...
            return {
              ...
              signup: function (data) {
                ...
                OAuthio.API.post(
                  "/api/usermanagement/signup?k=" + config.key,
                  data
                )
                  .done(function (res) {
                    storage.create(
              ...
              signin: function (email, password) {
                ...
                if (typeof email !== "string" && !password) {
                  ...
                  OAuthio.API.post(
                    "/api/usermanagement/signin?k=" + config.key,
                    signinData
                  )
                    .done(function (res) {
                      storage.create(
              ...
              confirmResetPassword: function (newPassword, sptoken) {
                return OAuthio.API.post(
                  "/api/usermanagement/user/password?k=" + config.key,
                  {
                    password: newPassword,
                    token: sptoken,
                  }
              ...
              resetPassword: function (email, callback) {
                return OAuthio.API.post(
                  "/api/usermanagement/user/password/reset?k=" + config.key,
                  {
                    email: email,
                  }
                );
              ...
              refreshIdentity: function () {
                ...
                OAuthio.API.get(
                  "/api/usermanagement/user?k=" +
                    config.key +
                    "&token=" +
                    JSON.parse(storage.read("oio_auth")).token
                )
                  .done(function (res) {
                    return defer.resolve(new UserObject(res.data));
                  })
          ...
          module.exports = {
            ...
            storeCache: function (provider, cache) {
              ...
              if (cache.expires_in) {
                ...
                this.config.options.expires ||
                this.config.options.expires === false
              ) {
                expires = this.config.options.expires;
              }
              this.storage.create(
                "oauthio_provider_" + provider,
          ...
          module.exports = {
            ...
            erase: function (name) {
              ...
              this.document.cookie =
                name + "=; expires=" + date.toGMTString() + "; path=/";
            },
          ...
          module.exports = {
            ...
            create: function (name, value, expires) {
              ...
              useCache(function (cacheobj, cacheupdate) {
                cacheobj[name] = expires
                  ? date.getTime() + (expires || 1200) * 1000
                  : false;
                return cacheupdate();
              });
            },
        ...
        function (require, module, exports) {
          ...
          module.exports = {
            ...
            sha1_vm_test: function () {
              return (
                thishex_sha1("abc").toLowerCase() ===
                "a9993e364706816aba3e25717850c26c9cd0d89d"
              );
            },
            rstr_sha1: function (s) {
              return this.binb2rstr(
                this.binb_sha1(this.rstr2binb(s), s.length * 8)
              );
            },
            rstr_hmac_sha1: function (key, data) {
              ...
              return this.binb2rstr(
                this.binb_sha1(opad.concat(hash), 512 + 160)
              );
            },
